...
Open Postman.
Click on the Gear Icon ⚙️ (Manage Environments) in the top right corner.
...
In the top right corner of Postman, select the newly created environment (Matatu-Link Backend) from the dropdown. 2. Creating Users via /api/auth/register Endpoint
...
Extract the user_id if needed for future references.
javascript
Copy code
...
Open Postman and ensure your environment (Matatu-Link Backend) is selected.
Create a New Request for each user as detailed above:
Click New > Request.
...
Optionally, query your database to inspect the users table and confirm that password_hash fields contain bcrypt hashes. 4. Logging In and Storing Tokens (Optional for Further Testing)
...
Attempt to log in with each user to confirm that authentication works and tokens are generated correctly. 7. Best Practices
Secure Passwords:
...
Use libraries like express-validator to streamline validation processes. 8. Conclusion
...
INSERT INTO user_roles (role_id, role_name) VALUES (2, 'operator') ON CONFLICT DO NOTHING; 2. Users
Table: users
...
(10, 'operator_ruai', 'ruai.operator@example.com', '$2b$10$1234567890abcdefghijklmnop', '0701234567', '2023-10-25', 2, TRUE); 3. Operators
Table: operators
...
(6, 'Kasarani Transit', 'kasarani@transit.co.ke', 'Kasarani, Nairobi', 8),
(7, 'Karura Riders', 'karura@riders.co.ke', 'Karura Forest, Nairobi', 9),
(8, 'Ruai Lines', 'info@rualines.co.ke', 'Ruai, Nairobi', 10); 4. Routes
Table: routes
...
(7, 'City Park to Karen', 'From City Park to Karen Road', 50.00, TRUE); 5. Stops
Table: stops
...
(10, 'Gigiri Embassy Area', -1.2710, 36.8150, 'Diplomatic area housing multiple embassies'); 6. Matatus
Table: matatus
...
(10, 7, 'KLX890J', 16, 3, 'active', 'Mercedes-Benz', 'Vario', 2021); 7. Route Stops
Table: route_stops
...
(10, 10, -1.2710, 36.8150, '2024-04-01 09:15:00'); 9. Contributions
Table: contributions
...
(10, 10, 'route', 'Suggest reducing fare on route 5 to promote usage.', '2024-03-24', 'rejected', 5, NULL, NULL); 10. Votes
Table: votes
...
(10, 2, 9, 'upvote', '2024-03-23 17:00:00'); 11. Reports
Table: reports
...
(10, 2, 6, NULL, 'other', 'Request for more frequent matatu services.', '2024-04-10', 'resolved'); 12. Fares
Table: fares
...
(10, 10, 10, 3, 40.00, 'cash', '2024-04-01 09:15:00', 'TXN1010'); 13. Notifications
Table: notifications
...
(10, 10, 'maintenance', 'Matatu KLX890J has completed maintenance and is back in service.', FALSE, '2024-04-01 10:45:00'); 14. Additional Data: Users' Password Hashes
...
Timestamps: All timestamp and date\_\* fields use realistic dates. Adjust these as needed based on your application's timeline.
